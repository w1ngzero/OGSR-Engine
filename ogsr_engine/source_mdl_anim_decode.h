...
<Project DefaultTargets="Build" ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <LinkIncremental Condition="$(Configuration.Contains('Debug')) And '$(EnableASAN)'=='true'">false</LinkIncremental>
    <LinkIncremental Condition="$(Configuration.Contains('Debug')) And '$(EnableASAN)'!='true'">true</LinkIncremental>
  </PropertyGroup>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Release|x64'">
    ...
    <PostBuildEvent>
      <Command>
        ...
        copy /Y "$(SolutionDir)\3rd_party\Src\NVIDIA_DLSS\DLSS\lib\Windows_x86_64\rel\nvngx_dlss.dll" "$(OutDir)nvngx_dlss.dll"
      </Command>
    </PostBuildEvent>
    <Manifest>
    ...
    <PreBuildEvent>
      <Command>call "$(ProjectDir)generate_build_info.bat"</Command>
    </PreBuildEvent>
  </ItemDefinitionGroup>
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    ...
    <ClCompile>
      ...
      <MultiProcessorCompilation>true</MultiProcessorCompilation>
      <DisableSpecificWarnings>4456;4457;4458;4995;4577;4315;4267;4267;</DisableSpecificWarnings>
      <BasicRuntimeChecks Condition="$(Configuration.Contains('Debug')) And '$(EnableASAN)'=='true'"></BasicRuntimeChecks>
      <BasicRuntimeChecks Condition="$(Configuration.Contains('Debug')) And '$(EnableASAN)'!='true'">EnableFastChecks</BasicRuntimeChecks>
    </ClCompile>
    <ResourceCompile>
      <PreprocessorDefinitions>NDEBUG;%(PreprocessorDefinitions)</PreprocessorDefinitions>
      <Culture>0x0422</Culture>
    ...
    <PostBuildEvent>
      <Command>
        copy /Y "$(SolutionDir)\3rd_party\Src\OpenAL_Soft\bin\$(PlatformShortName)\soft_oal.dll" "$(OutDir)OpenAL32.dll"
        copy /Y "$(SolutionDir)\3rd_party\Src\NVIDIA_DLSS\DLSS\lib\Windows_x86_64\dev\nvngx_dlss.dll" "$(OutDir)nvngx_dlss.dll"
      </Command>
    </PostBuildEvent>
    <Manifest>
      <AdditionalManifestFiles>manifest.xml %(AdditionalManifestFiles)</AdditionalManifestFiles>
  ...
  <ItemGroup>
    ...
    <ClInclude Include="source_mdl\source_mdl_skeleton.h" />
    <ClInclude Include="source_mdl\source_mdl_to_xray.h" />
    <ClInclude Include="source_mdl\source_mdl_import.h" />
    <ClInclude Include="source_mdl\source_mdl_basis.h" />
    <ClInclude Include="source_mdl\source_mdl_basis_xray.h" />
    <ClInclude Include="source_mdl\source_mdl_mesh.h" />
    <ClInclude Include="source_mdl\source_mdl_mesh_read.h" />
    <ClInclude Include="source_mdl\source_mdl_mesh_to_xray.h" />
    <ClInclude Include="source_mdl\source_mdl_anim.h" />
    <ClInclude Include="source_mdl\source_mdl_anim_q.h" />
    <ClInclude Include="source_mdl\source_mdl_anim_to_xray.h" />
    <ClInclude Include="source_mdl\source_mdl_vvd.h" />
    <ClInclude Include="source_mdl\source_mdl_vtx.h" />
    <ClInclude Include="source_mdl\source_mdl_split_mesh.h" />
  ...
  <ItemGroup>
    ...
    <ClCompile Include="source_mdl\source_mdl_skeleton.cpp" />
    <ClCompile Include="source_mdl\source_mdl_to_xray.cpp" />
    <ClCompile Include="source_mdl\source_mdl_import.cpp" />
    <ClCompile Include="source_mdl\source_mdl_basis.cpp" />
    <ClCompile Include="source_mdl\source_mdl_mesh.cpp" />
    <ClCompile Include="source_mdl\source_mdl_mesh_read.cpp" />
    <ClCompile Include="source_mdl\source_mdl_mesh_to_xray.cpp" />
    <ClCompile Include="source_mdl\source_mdl_anim.cpp" />
    <ClCompile Include="source_mdl\source_mdl_anim_to_xray.cpp" />
    <ClCompile Include="source_mdl\source_mdl_anim_decode.cpp" />
    <ClCompile Include="source_mdl\source_mdl_mesh_ogf.cpp" />
    <ClCompile Include="source_mdl\source_mdl_vvd.cpp" />
    <ClCompile Include="source_mdl\source_mdl_vtx.cpp" />
    <ClCompile Include="source_mdl\source_mdl_split_mesh.cpp" />
  ...
  <ItemGroup>
    <None Include="generate_build_info.bat" />
  ...
  <ItemGroup>
    ...
    <Image Include="stalker.ico" />
  </ItemGroup>
  <Import Project="$(VCTargetsPath)\Microsoft.Cpp.targets" />
  <Target Name="PostBuildStep1" AfterTargets="Build">
    <Exec Command='copy /Y "$(WindowsSDKDir)Debuggers\$(PlatformShortName)\dbghelp.dll" "$(OutDir)dbghelp.dll"' />
  </Target>
